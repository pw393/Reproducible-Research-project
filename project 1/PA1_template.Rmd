...
<html lang="en" class=" is-copy-enabled is-u2f-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTQzNjIwMzc3OmY2NTU4NmRmZWRjZGYxNjZhNjgxOGQ1MTZhMjk0N2I3MWY2YTIxNmRkZTBkMWY2MTI4NDViMzA5ODdmY2Q2MzM=--551b29de4b1f1474d8a41c673f52a376af08bc0c">
    <meta name="pjax-timeout" content="1000">
    <link rel="sudo-modal" href="/sessions/sudo_modal">
    <meta name="request-id" content="80547F1A:7728:11E7C41D:58641D87" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="80547F1A:7728:11E7C41D:58641D87" name="octolytics-dimension-request_id" /><meta content="24728765" name="octolytics-actor-id" /><meta content="pw393" name="octolytics-actor-login" /><meta content="bcc02828e23f3e9189e6c63ea01888ed226c8a62f482a38986f0226fdc1162f1" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="pw393">
      ...
      <meta name="js-proxy-site-detection-payload" content="OWM5NTllNTdlZWU5YzY2ZjBmYTUwMDlmYWZlZGE0NDBjZTljYWM3M2M1NWE5OTFhNjBlN2YwZTkyZTJjNmRiOHx7InJlbW90ZV9hZGRyZXNzIjoiMTI4Ljg0LjEyNy4yNiIsInJlcXVlc3RfaWQiOiI4MDU0N0YxQTo3NzI4OjExRTdDNDFEOjU4NjQxRDg3IiwidGltZXN0YW1wIjoxNDgyOTU2MTY3LCJob3N0IjoiZ2l0aHViLmNvbSJ9">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="05SzipChzBcQY2EIbNmPQcmtjd7RYmqSOhA64cUm3pO4GJTRGRQRUK2W9oEUtTBTHeqJKYBk+03V4VsFz9TBaw==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="rWfizPsFE/2b1DmpmuIwuq5RJZWNk8tE/rXh6YO5f6eH2ZX4A7eGSpepIhMS+BEYZYcyGVz4RFeXHipURb4VYA==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="19899531" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/sefakilic/coursera-repdata/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="TERYoQDqjTFdNmklAt1lRZoP1nHcqLvmdkzheOks8di+WVENQXBFJI5hk3K+WA/bPB5xvlw79aWEw9esO+YCew==" /></div>
      <button
        type="submit"
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/sefakilic/coursera-repdata/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="vYmIOHOxIgt6fZAUD0rxNMpbWkuU+X929wmyHupXR/k7X7EE86Au9ScwFjVk5tqpG8A56vJKixylMrSyvpbNWw==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/sefakilic/coursera-repdata/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="QFB8VgRFMLs8+abHgoElTORdYREkndQqSf9EvN5JIgTYydDXzjcyjDfLdXJsw59x6F7M4ullue/HxV0NCbyeEg==" /></div>
            <button
                type="submit"
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/sefakilic/coursera-repdata/raw/master/project1/PA1_template.Rmd" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/sefakilic/coursera-repdata/blame/master/project1/PA1_template.Rmd" class="btn btn-sm js-update-url-with-hash BtnGroup-item">Blame</a>
      <a href="/sefakilic/coursera-repdata/commits/master/project1/PA1_template.Rmd" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/sefakilic/coursera-repdata/edit/master/project1/PA1_template.Rmd" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="NBacqj/s0kBPf5ISBJcIhwRzLpqrqHxyWAdJCwARTlY+ZaKtaPrYUxa4mVVhBLJrtlkqdDOvkZL6P+PNovgOqw==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Edit the file in your fork of this project" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/sefakilic/coursera-repdata/delete/master/project1/PA1_template.Rmd" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="iDjVkLCz09hBP3dsY/1ulEZ+TNn/u2u8NS6tazCUevqKqqS6fSuo55wwGR195IuCVc0bc+NLfVtNg4nEdj7mDw==" /></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2016 <span title="0.08122s from github-fe-5989992.cp1-iad.github.net">GitHub</span>, Inc.</li>
